...
namespace APBD_Projekt.Migrations
{
    ...
    [Migration("20240628141817_SubskrybjceAddedWithCLient1")]
    partial class SubskrybjceAddedWithCLient1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APBD_Projekt.Models.Platnosc", b =>
                {
                    ...
                    b.HasOne("APBD_Projekt.Models.Subskrybcja", "Subskrybcja")
                        .WithMany("Platnosci")
                        .HasForeignKey("SubskrybjcaID");

                    b.Navigation("Kontrakt");

                    b.Navigation("Subskrybcja");
                });
